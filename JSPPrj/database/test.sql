...
AS
SELECT N.ID, N.TITLE, N.WRITER_ID, N.REGDATE, N.HIT, N.FILES, N.PUB ,COUNT(C.ID) cmt_count
FROM NOTICE1 N
LEFT JOIN COMMENT1 C ON N.ID = C.NOTICE_ID
...
UPDATE notice1 SET pub=1 WHERE id = 12;
...
INSERT INTO NOTICE1(ID,TITLE, CONTENT, WRITER_ID, PUB)
VALUES (NOTICE_SEQ.NEXTVAL,'gameflix제작','content...','newlec',1);

DELETE NOTICE1
  WHERE title = 'gameflix제작';